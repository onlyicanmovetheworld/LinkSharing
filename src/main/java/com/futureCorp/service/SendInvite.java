...
public class SendInvite implements SendInviteInterface,SendEmail {
    ...
    public Boolean sendingInviteEmail(String to, String topic,String who) {
        String message="<html><body>You were sent an invitation by "+who+"<br><a href=\"http://10.1.12.53:8080/subscribeToInvite?name="+topic+"\">Click Here</a> to subscribe now <body></html>";
